...
function RegisterForm({ error, onSubmit, onLogin }: RegisterFormProps) {
  const [data, setData] = useState<RegistrationData>({
    nombre: "", apellido: "", telefono: "", email: "", password: "", direccion: "", rol: "USUARIO",
  });
  ...
  return (
    <form className="auth-form auth-form--register" onSubmit={handleSubmit}>
      ...
      <p className="auth-form__intro">Regístrate para comprar y vender moda en Bolivia.</p>
      ...
      <div><label htmlFor="rol">Rol de la cuenta</label><select id="rol" value={data.rol} onChange={(event) => updateField("rol", event.target.value as "USUARIO")}><option value="USUARIO">Usuario: comprar y vender</option></select></div>
